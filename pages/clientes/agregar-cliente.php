...
<html
  ...
  <head>
    ...
    <title>Agregar Cliente | Centro Médico - UNI</title>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="./gestionar-cliente.php" class="menu-link">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <img src="https://cdn-icons-png.flaticon.com/128/11267/11267559.png" alt="">
                  <p> <span class="c-blue">Agregar </span> <span class="c-green">cliente</span> </p>
                </div>
              </div>
              <!-- /Search -->
