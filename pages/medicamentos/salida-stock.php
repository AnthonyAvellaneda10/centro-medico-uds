...
<html
  ...
  <head>
    ...
    <title>Salida stock | Centro Médico - UNI</title>
  ...
  <body>
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <img src="https://cdn-icons-png.flaticon.com/128/179/179469.png" alt="">
                  <p> <span class="c-blue">Salida </span> <span class="c-green">stock</span> </p>
                </div>
              </div>
              <!-- /Search -->
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">Código de estudiante</label>
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="Código de estudiante" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Motivo</label>
                        ...
                        <div class="mb-3">
                          ...
                          <input type="text" class="form-control" id="basic-default-company" placeholder="Fecha de salida" disabled style="cursor: no-drop;" />
                        </div>
                        <div class="btns-contain">
                            <button type="submit" class="btn btn-primary">Registrar medicina</button>
                            <button class="btn btn-primary" id="redirect-salida-medicina">Buscar medicina</button>
                        </div>
                      </form>
                    </div>
                  </div>
    ...
    <script src="../../dist/js/redirect_salida_medicina.js"></script>
