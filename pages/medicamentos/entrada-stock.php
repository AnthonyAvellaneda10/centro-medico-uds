...
<html
  ...
  <head>
    ...
    <title>Entada stock | Centro Médico - UNI</title>
  ...
  <body>
                ...
                <li class="menu-item open">
                  ...
                  <ul class="menu-sub">
                    <li class="menu-item active" style="margin-left: 15px;">
                        <a href="javascript:vodi(0);" class="menu-link">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <img src="https://cdn-icons-png.flaticon.com/128/179/179468.png" alt="">
                  <p> <span class="c-blue">Entrada </span> <span class="c-green">stock</span> </p>
                </div>
              </div>
              <!-- /Search -->
                ...
                <div class="col-xl">
                  <div class="card mb-4">
                    <div class="card-body">
                      <form>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-fullname">N° de orden de compra</label>
                          <input type="text" class="form-control" id="basic-default-fullname" placeholder="N° de orden de compra" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">N° de lote</label>
                          <input type="text" class="form-control" id="basic-default-company" placeholder="N° de lote" />
                        </div>
                        <div class="mb-3">
                          <label class="form-label" for="basic-default-company">Fecha de ingreso</label>
                          <input type="text" class="form-control" id="basic-default-company" placeholder="Fecha de ingreso" disabled style="cursor: no-drop;" />
                        </div>
                        <div class="btns-contain">
                            <button type="submit" class="btn btn-primary">Registrar medicina</button>
                            <button class="btn btn-primary" id="redirect-buscar-medicina">Buscar medicina</button>
                        </div>
                      </form>
                    </div>
                  </div>
    ...
    <script src="../../dist/js/redirect_buscar_medicina.js"></script>
