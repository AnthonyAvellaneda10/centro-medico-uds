...
<html
  ...
  <head>
    ...
    <title>Agregar Medicamento | Centro Médico - UNI</title>
    ...
    <link rel="stylesheet" href="../../dist/css/form_label_reset.css">
  ...
  <body>
      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Menú -->
            <li class="menu-item">
              <a href="../home/index.phpindex.php" class="menu-link">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <img src="https://cdn-icons-png.flaticon.com/128/873/873654.png" alt="">
                  <p> <span class="c-blue">Agregar </span> <span class="c-green">medicamento</span> </p>
                </div>
              </div>
              <!-- /Search -->
                      ...
                      <form id="agregarMedicamento">
                        <div class="row">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select id="laboratorio" name="laboratorio" class="select2 form-select">
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <input class="form-control" type="text" name="nombre_comercial" id="nombre_comercial" placeholder="Nombre comercial" />
                          </div>
                          <div class="mb-3 col-md-6">
                            <label class="form-label" for="especialidad">Especialidad</label>
                            <select id="especialidad" name="especialidad" class="select2 form-select">
                              <option disabled selected>Elige una opción</option>
                              <option value="Australia">Australia</option>
                              <option value="Bangladesh">Bangladesh</option>
                              <option value="Belarus">Belarus</option>
                          ...
                          <div class="mb-3 col-md-6">
                            <label class="form-label" for="forma_farma">Forma farmacéutica</label>
                            <select id="forma_farma" name="forma_farma" class="select2 form-select">
                              <option disabled selected>Elige una opción</option>
                              <option value="Australia">Australia</option>
                              <option value="Bangladesh">Bangladesh</option>
                              <option value="Belarus">Belarus</option>
                          ...
                          <div class="mb-3 col-md-6">
                            ...
                            <select id="presentacion" name="presentacion" class="select2 form-select">
                              <option disabled selected>Elige una opción</option>
                              <option value="Australia">Australia</option>
                              <option value="Bangladesh">Bangladesh</option>
                              <option value="Belarus">Belarus</option>
                          ...
                          <div class="mb-3 col-md-6">
                            <label class="form-label" for="grupo_ter">Grupo terapeútico</label>
                            <select id="grupo_ter" name="grupo_ter" class="select2 form-select">
                              <option disabled selected>Elige una opción</option>
                              <option value="Australia">Australia</option>
                              <option value="Bangladesh">Bangladesh</option>
                              <option value="Belarus">Belarus</option>
                        ...
                        <div class="mt-2 d-flex justify-content-center">
                          <button type="submit" class="btn btn-primary me-2 nextBtn">Enviar</button>
                        </div>
                      </form>
                    </div>
                    <!-- /Account -->
    ...
    <script src="../../dist/js/agregar-medicamento.js"></script>
