...
<html
  ...
  <head>
    ...
    <title>Agregar Distribuidor | Centro Médico - UNI</title>
          ...
          <ul class="menu-inner py-1">
            ...
            <li class="menu-item active open">
              ...
              <ul class="menu-sub">
                ...
                <li class="menu-item">
                  <a href="./gestionar-distribuidor.php" class="menu-link">
            ...
            <div class="navbar-nav-right d-flex align-items-center" id="navbar-collapse">
              ...
              <div class="navbar-nav align-items-center">
                <div class="nav-item d-flex align-items-center">
                  <img src="https://cdn-icons-png.flaticon.com/128/4867/4867560.png" alt="">
                  <p> <span class="c-blue">Agregar </span> <span class="c-green">distribuidor</span> </p>
                </div>
              </div>
              <!-- /Search -->
